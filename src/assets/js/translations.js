    ...
    this.translations = {
      en: {
        ...
        'channel-type-description':
          'Send messages, images, GIFs, emojis, ideas, and jokes',
        'channel-type-voice-description':
          'Talk or video chat together, or share your screen',
        ...
        'join-a-guild-detail':
          'Enter an invitation below to join an existing guild.',
        'customize-guild': 'Customize your guild',
        'customize-guild-detail':
          'Add a name and icon to your new guild to give it personality. You can change these anytime you want.',
        guildname: 'Guild Name',
        create: 'Create',
        'guild-join-invite-title':
          'INVITE CODE - Please enter a valid invite link or invite code',
        ...
        'create-your-guild-detail':
          'Your guild is the place where you hang out with your friends. Create your own guild and start chatting.',
        'guild-born-title': 'Welcome to guild',
        'fail-message-text':
          'The message could not be delivered. This might be because you do not share any servers with the recipient or the recipient only accepts direct messages from friends.',
        'start-of-guild': 'This, is the start of guild.',
        channelSearchInput: 'Search',
        friendsSearchInput: 'Search',
        addfriendtext: 'Add Friend',
        addfrienddetailtext:
          'You can add your friends with their LiventCord name.',
        addfriendinputbutton: 'Send Friend Request',
        'send-message': 'Send Message',
        more: 'More',
        addFriendDiscriminatorErrorText: 'Invalid discriminator! (#0000)',
        'upload-error-message':
          'You can only upload image files! (JPG, PNG veya GIF)!',
      ...
      tr: {
        ...
        'channel-type-voice-description':
          'Birlikte sesli veya görüntülü konuşun veya ekran paylaşın',
        ...
        create: 'Oluştur',
        'guild-join-invite-title':
          'DAVET BAĞLANTISI - Lütfen geçerli bir davet bağlantısı veya davet kodu gir.',
        ...
        'invites-guild-detail':
          'Veya bir arkadaşına sunucu daveti bağlantısı yolla',
        'guild-born-title': 'klanına hoşgeldin!',
        'fail-message-text':
          'Mesajın iletilemedi. Bunun nedeni alıcıyla herhangi bir sunucu paylaşmıyor olman veya alıcının sadece arkadaşlarından direkt mesaj kabul ediyor olması olabilir.',
        'start-of-guild': 'Bu, sunucunun başlangıcıdır.',
        channelSearchInput: 'Ara',
        friendsSearchInput: 'Ara',
        addfriendtext: 'Arkadaş ekle',
        addfrienddetailtext:
          'Arkadaşlarını LiventCord kullanıcı adı ile ekleyebilirsin.',
        ...
        'upload-error-message':
          'Yalnızca resim dosyaları yükleyebilirsiniz (JPG, PNG veya GIF)!',
  ...
  settingTranslations = {
    en: {
      ...
      AutoShareActivityParticipation:
        'LiventCord automatically shares your participation in activities.',
      Overview: 'Overview',
      GuildName: 'Guild Name',
      Remove: 'Remove',
      Username: 'Username',
